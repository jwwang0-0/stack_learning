...
from models.cnn_policy import CnnPolicyNet
from models.cnn_value import CnnValueNect
...
policy_net = CnnPolicyNet(env.action_space.shape[0], 
                          feature_dim=args.hidden_n, 
                          log_std=args.log_std)
value_net = CnnValueNect(feature_dim=args.hidden_n)
